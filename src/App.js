...
import MHTShastriNagar from './Pages/LocationsPages/MHTShastriNagar';
import MHTSahunagar from './Pages/LocationsPages/MHTSahunagar';
import MHTRavet from './Pages/LocationsPages/MHTRavet';
import MHTThergaon from './Pages/LocationsPages/MHTThergaon';
import MHTShivajiNagar from './Pages/LocationsPages/MHTShivajiNagar';
import MHTPune from './Pages/LocationsPages/MHTPune';
import MHTWagholi from './Pages/LocationsPages/MHTWagholi';
import MHTDholePatil from './Pages/LocationsPages/MHTDholePatil';
import MHTBundGarden from './Pages/LocationsPages/MHTBundGarden';
import MHTPimpriChinchwad from './Pages/LocationsPages/MHTPimpriChinchwad';
...
import MHTUndri from './Pages/LocationsPages/MHTUndri';
import MHTSwargate from './Pages/LocationsPages/MHTSwargate';
import MHTSadashiv from './Pages/LocationsPages/MHTSadashiv';
...
// 
import IITJEEBibwewadi from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-bibwewadi-pune";
import IITJEEFursungi from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-fursungi-pune";
import IITJEEKalepadal from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-kalepadal-pune";
import IITJEELoniKalbhor from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-loni-kalbhor-pune";
import IITJEELullaNagar from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-lulla-nagar-pune";
import IITJEEManjari from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-manjari-pune";
import IITJEEMGRoad from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-mg-road-pune";
import IITJEENanaPeth from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-nana-peth-pune";
import IITJEESadhuVaswaniChowk from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-sadhu-vaswani-chowk-pune";
import IITJEESalunkheVihar from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-salunkhe-vihar-pune";

// 
import IITJEEWagholi from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-wagholi-pune";
import IITJEEUndri from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-undri-pune";
import IITJEEShivajiNagar from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-shivaji-nagar-pune";
import IITJEEJMRoad from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-jm-road-pune";
import IITJEENIBM from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-nibm-pune";
import IITJEEMundhwa from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-mundhwa-pune";
...
import IITJEEDighi from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-dighi-pune";
import IITJEEShahuNagar from "./Pages/LocationsPages/IIT JEE Pages/iit-jee-shahu-nagar-pune";
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/mht-cet-coaching-classes-institute-in-shastri-nagar-pune' element={<MHTShastriNagar />} />
          <Route path='/mht-cet-course-classes-institute-in-sahunagar-pune' element={<MHTSahunagar />} />
          <Route path='/mht-cet-coaching-classes-institute-in-ravet-pune' element={<MHTRavet />} />
          <Route path='/mht-cet-course-classes-institute-in-thergaon-pune' element={<MHTThergaon />} />
          <Route path='/mht-cet-course-classes-institute-in-shivaji-nagar-pune' element={<MHTShivajiNagar />} />
          <Route path='/mht-cet-coaching-classes-institute-in-pune' element={<MHTPune />} />
          <Route path='/mht-cet-coaching-classes-institute-in-wagholi-pune' element={<MHTWagholi />} />
          <Route path='/mht-cet-coaching-classes-institute-in-dhole-patil-road-pune' element={<MHTDholePatil />} />
          <Route path='/mht-cet-coaching-classes-institute-in-bund-garden-pune' element={<MHTBundGarden />} />
          <Route path='/mht-cet-coaching-classes-institute-in-pimpri-chinchwad-pune' element={<MHTPimpriChinchwad />} />
          <Route path='/mht-cet-coaching-classes-institute-in-kalewadi-pune' element={<MHTKalewadi />} />
          <Route path='/mht-cet-coaching-classes-institute-in-hinjewadi-pune' element={<MHTHinjewadi />} />
          <Route path='/mht-cet-coaching-classes-institute-in-fatima-nagar-pune' element={<MHTFatimaNagar />} />
          <Route path='/mht-cet-coaching-classes-institute-in-undri-pune' element={<MHTUndri />} />
          <Route path='/mht-cet-coaching-classes-institute-swargate-pune' element={<MHTSwargate />} />
          <Route path='/mht-cet-coaching-classes-institute-in-sadashiv-peth-pune' element={<MHTSadashiv />} />
        ...
        <Route path='/iit-jee-coaching-classes-institute-kasarwadi-pune' element={<IITJEEKasarwadi />} />
                <Route path='/iit-jee-coaching-classes-institute-nigdi-pune' element={<IITJEENigdi />} />
                        <Route path='/iit-jee-coaching-classes-kondhwa-pune' element={<IITJEEKondhwa />} />
                              <Route path='/iit-jee-coaching-classes-institute-akurdi-pune' element={<IITJEEAkurdi />} />
...
<Route path='/iit-jee-coaching-classes-Institute-bibwewadi-pune' element={<IITJEEBibwewadi />} />
<Route path='/iit-jee-coaching-classes-institute-fursungi-pune' element={<IITJEEFursungi />} />
<Route path='/iit-jee-coaching-classes-institute-kalepadal-pune' element={<IITJEEKalepadal />} />
<Route path='/iit-jee-coaching-classes-institute-loni-kalbhor-pune' element={<IITJEELoniKalbhor />} />
<Route path='/iit-jee-coaching-classes-Institute-lulla-nagar-pune' element={<IITJEELullaNagar />} />
<Route path='/iit-jee-coaching-classes-institute-manjari-pune' element={<IITJEEManjari />} />
<Route path='/iit-jee-coaching-classes-institute-mg-road-pune' element={<IITJEEMGRoad />} />
<Route path='/iit-jee-coaching-classes-institute-nana-peth-pune' element={<IITJEENanaPeth />} />
<Route path='/iit-jee-coaching-classes-institute-sadhu-vaswani-chowk-pune' element={<IITJEESadhuVaswaniChowk />} />
...
<Route path='/iit-jee-coaching-classes-institute-in-nibm-pune' element={<IITJEENIBM />} />

<Route path='/iit-jee-coaching-classes-institute-in-mundhwa-pune' element={<IITJEEMundhwa />} />

<Route path='/iit-jee-coaching-classes-in-pimple-gurav-pune' element={<IITJEEPimpleGurav />} />
...
{/*  */}
<Route path='/iit-jee-coaching-classes-institute-dighi-pune' element={<IITJEEDighi />}/>
<Route path='/iit-jee-coaching-classes-institute-shahu-Nagar-pune'element={<IITJEEShahuNagar />}/>
<Route path='/iit-jee-coaching-classes-institute-purna-nagar-chinchwad-pune' element={<IITJEEPurnaNagarChinchwad />}/>
