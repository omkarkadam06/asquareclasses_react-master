...
`}</script>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-12 col-lg-8 col-md-12 text-center text-md-start">
              ...
              >
               ...
               <motion.h2>Premier Coaching Institute for Engineering Aspirants in Pimpri</motion.h2>
      ...
      {/* Why Choose */} <section className="jee-why py-5 ">
        ...
        >Why Choose{" "}
          <span className="text-primary">ASQUARE Academy in</span>  Pimpri</motion.h3>
