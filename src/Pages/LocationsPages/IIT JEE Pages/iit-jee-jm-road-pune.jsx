...
function IITJEEJMRoad() {
  ...
  const faqs = [
    { q: "Who can join ASQUARE Academy JM Road?", a: "Students of Class XI, XII and XII pass-outs preparing for JEE Main & Advanced." },
    ...
    { q: "Which areas does the JM Road branch serve?", a: "Convenient for students from JM Road, Wanwadi, Undri, Kondhwa, Mohammed Wadi and nearby Pune localities." },
    { q: "How can I enroll?", a: "Contact the JM Road branch or use the enquiry form on this page to reserve your seat — admissions are limited." },
  ];

  return (
    <>
      <Helmet>
        <title>IIT JEE Coaching Classes in JM Road Pune | Best JEE Institute</title>
        <meta name="title" content="IIT JEE Coaching Classes in JM Road Pune | Best JEE Institute" />
        <meta name="description" content="Join top IIT JEE coaching classes in JM Road Pune at ASQUARE Academy. Expert faculty, small batches, mock tests & PCM coaching for JEE Main & Advanced. Enroll now!" />
        <meta name="keywords" content={`IIT JEE coaching classes in JM Road Pune,
Best IIT JEE Coaching in  JM Road Pune,
Top JEE Mains Coaching Classes JM Road Pune,
IIT JEE Advanced Preparation JM Road Pune,
JEE Advanced coaching classes in JM Road Pune,
IIT JEE Classes in JM Road Pune,
Best IIT JEE Classes in JM Road Pune,
Top IIT JEE Classes in JM Road Pune,
IIT JEE Institute coaching in JM Road Pune,
IIT JEE Institute classes in JM Road Pune,
`} />
        ...
        <script type="application/ld+json">{`
{
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune#localbusiness",
      "name": "ASQUARE Academy - IIT JEE Coaching JM Road Pune",
      "image": "https://www.asquareclasses.com/static/media/asquare-logo-new.a0947d5409b087e3562a.png",
      "url": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune",
      "telephone": "9766118877",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "JM Road",
      ...
      "description": "Top IIT JEE Coaching Classes in JM Road Pune for JEE Main & Advanced with expert faculty, mock tests, PCM coaching & small batches."
    },
    {
      "@type": "WebPage",
      "@id": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune#webpage",
      "url": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune",
      "name": "IIT JEE Coaching Classes in JM Road Pune",
      "isPartOf": {
      ...
      "description": "Best IIT JEE coaching institute in JM Road Pune offering JEE Main & Advanced preparation with PCM coaching, mock tests & focused batches."
    },
    {
      "@type": "EducationalOrganization",
      "@id": "https://www.asquareclasses.com/#education",
    ...
    {
      "@type": "BreadcrumbList",
      "@id": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune#breadcrumbs",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          ...
          "position": 3,
          "name": "IIT JEE Coaching Classes in JM Road Pune",
          "item": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune"
        }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "https://www.asquareclasses.com/iit-jee-coaching-classes-institute-in-jm-road-pune#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Who can join ASQUARE Academy JM Road?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, weekly unit tests and full-length mock exams are included."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We offer 2-Year, 1-Year, Crash Courses & Dropper Batches."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We keep batch sizes small for personalized attention."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, parents receive updates through PTMs and detailed progress reports."
          }
        },
        {
          "@type": "Question",
          "name": "Which areas does the JM Road branch serve?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Students from JM Road, Deccan, Shivaji Nagar, FC Road, and nearby Pune areas can join."
          }
        }
      ]
    }
...
Excel in JEE Main & Advanced with  <span className="highlight-text text-warning">ASQUARE Academy JM Road</span>
              </motion.h1>

              <motion.h2>Premier Coaching Destination for IIT-JEE Aspirants on JM Road</motion.h2>

              <p className="lead d-none d-md-block">
              Looking for IIT-JEE coaching classes in JM Road, Pune? At ASQUARE Academy, we provide concept-focused teaching, structured study material, and expert mentorship that prepare students for JEE Main & Advanced. Our JM Road branch is designed to help aspirants develop concept clarity, exam strategies, and strong problem-solving skills to gain admission into IITs, NITs, IIITs, and India’s top engineering institutes.
              </p>
            ...
            <div className="col-12 col-lg-4 col-md-12 mt-5 mt-md-0 text-center">
              <img src={sampleimg3} alt="ASQUARE Academy JM Road" className="img-fluid mx-auto fade-in imgsiz" style={{ objectFit: "contain", opacity: 0.95, borderRadius: "10px" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="jee-why py-5">
        <div className="container">
          <motion.h3 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="fw-bold display-6 mb-3 text-center">Why ASQUARE Academy JM Road is the Right Choice</motion.h3>
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-8 text-center text-lg-start order-2">
              ...
              <p className="lead text-secondary">The Joint Entrance Examination (JEE) requires dedication, clarity and continuous practice. Our JM Road programs are designed to strengthen fundamentals, boost speed & accuracy and improve exam strategies for both JEE Main & Advanced.</p>
            </div>
      ...
      <section className="jee-gradient-section py-5 text-white">
        <div className="container">
          <motion.h4 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="fw-bold display-6 mb-3 text-center">Subjects We Teach at JM Road Branch</motion.h4>
      ...
      <section className="jee-highlights py-5 text-white">
        <div className="container text-center">
          <motion.h3 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="fw-bold display-6 mb-3">Key Highlights of ASQUARE Academy – JM Road</motion.h3>

          <div className="row justify-content-center g-4">
            {["Small batch strength for individual focus","Updated IIT-JEE study material, test papers & question banks","Workshops on time management, problem-solving & exam shortcuts","Regular student performance tracking and parent updates","Recognized as a leading JEE coaching institute in JM Road, Pune"].map((text, i) => (
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-8 text-center text-lg-start">
              ...
              <p className="lead text-light">ASQUARE Academy has produced IIT-JEE qualifiers and top scorers across Pune. The JM Road branch carries this legacy forward with student-focused coaching, expert mentorship, and result-oriented preparation.</p>
            </div>
        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-md-6 mb-4 mb-md-0">
              <FAQAccordion faqs={faqs.slice(0, Math.ceil(faqs.length / 2))} accordionId="JM RoadFaqLeft" />
            </div>
            <div className="col-12 col-md-6">
              <FAQAccordion faqs={faqs.slice(Math.ceil(faqs.length / 2))} accordionId="JM RoadFaqRight" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="enroll" className="jee-enroll-section py-5 text-center text-white">
        <div className="container">
          <motion.h3 initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="fw-bold display-6 mb-3">Enroll Today at <span className="highlight-text text-warning">ASQUARE Academy – JM Road</span></motion.h3>

          <p className="lead mb-4">Begin your IIT-JEE journey with ASQUARE Academy’s expert coaching in JM Road, Pune. With skilled faculty, updated material, and consistent results, we are your trusted partner for JEE, CET & NEET preparation.</p>

          <p><MapPin className="text-warning" /> Serving students from <b className="bld">JM Road, Deccan, Shivaji Nagar, FC Road, and nearby Pune localities.</b></p>
